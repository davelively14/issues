defmodule Issues.TableFormatter do
  ...
  identified by ecah header. That is, each header identifies a column,
  and those columns are extracted and printed from the rows. We calculate
  the width of each column to fit the longest element in that column.
  """
  ...
  @doc """
  Given a list containing sublists, where each sublist contains teh data for
  ...
  and a format string, write the extracated data under control of the former string.
  """
